...
(defun prettify-setup ()
  ...
  (push '("\\implies" . "⟹") tex--prettify-symbols-alist)
  (push '("\\impliedby" . "⟸") tex--prettify-symbols-alist)
  (push '("\\land" . "∧") tex--prettify-symbols-alist)
  (push '("\\lor" . "∨") tex--prettify-symbols-alist)
  (push '("\\dots" . 8230) tex--prettify-symbols-alist)
  (push '("\\varnothing" . "∅") tex--prettify-symbols-alist)
  (push (cons "\\textdegree{}" (cdr (assoc "\\textdegree" tex--prettify-symbols-alist))) tex--prettify-symbols-alist)
  (push (cons "\\Z" (cdr (assoc "\\mathbb{Z}" tex--prettify-symbols-alist))) tex--prettify-symbols-alist)
  (push (cons "\\N" (cdr (assoc "\\mathbb{N}" tex--prettify-symbols-alist))) tex--prettify-symbols-alist)
  (push (cons "\\R" (cdr (assoc "\\mathbb{R}" tex--prettify-symbols-alist))) tex--prettify-symbols-alist)
  (push (cons "\\Q" (cdr (assoc "\\mathbb{Q}" tex--prettify-symbols-alist))) tex--prettify-symbols-alist)
  (when (not (string= (font-get doom-font :family) "PragmataPro"))
    (dotimes (l 26)
      ;; mathcal -> bold-italic math script
      (add-to-list 'tex--prettify-symbols-alist (cons (concat "\\mathcal{" (byte-to-string (+ ?A l)) "}") (+ 120380 l))))
    )
  (dotimes (l 26)
    ;; mathscr -> mathcal
    (let* ((letter (byte-to-string (+ ?A l)))
      ...
      (add-to-list 'tex--prettify-symbols-alist (cons scr (cdr (assoc cal tex--prettify-symbols-alist))))
      ))
